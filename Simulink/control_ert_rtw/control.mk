...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/control.exe
...
%.obj : $(START_DIR)/control_ert_rtw/%.c
	$(CC) $(CFLAGS) -Fo"$@" $(subst /,\,"$<")
...
control.obj : $(START_DIR)/control_ert_rtw/control.c
	$(CC) $(CFLAGS) -Fo"$@" $(subst /,\,"$<")


ert_main.obj : $(START_DIR)/control_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -Fo"$@" $(subst /,\,"$<")
